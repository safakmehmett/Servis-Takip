            ...
            <form action="<?php echo base_url('panel/updatepassword/'); echo ''.$userinfo->id.'' ?>" method="post">
                <div class="modal-body">
                    <fieldset class="form-group floating-label-form-group">
                        ...
                        <input name="oldpassword" type="password" class="form-control" id="oldpassword" placeholder="Eski Şifreyi Giriniz" required>
                    </fieldset>
					<fieldset class="form-group floating-label-form-group">
                        <label for="password">Yeni Şifre</label>
                        <input name="newpassword" type="password" class="form-control" id="newpassword" placeholder="Yeni Şifreyi Giriniz" required>
                    </fieldset>
					<fieldset class="form-group floating-label-form-group">
                        <label for="password">Yeni Şifre Tekrar</label>
                        <input name="confpassword" type="password" class="form-control" id="confpassword" placeholder="Yeni Şifreyi Tekrar Giriniz" required>
                    </fieldset>
                </div>
...
toastr.error('<?php echo $userinfo->username; ?> Kullanıcısının Şifresi Değiştirilememiştir.', 'HATA', {
      "showMethod": "slideDown",
      "hideMethod": "slideUp",
      timeOut: 3000
    });
