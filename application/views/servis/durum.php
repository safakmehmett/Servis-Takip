                ...
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body card-dashboard table-responsive">
							...
							<a href="<?php echo base_url('/newquery'); ?>">
								<button type="button" class="btn mr-1 mb-1 btn-secondary" style="float: right;">Yeni Sorgu</button>
							</a>
							<button onclick="javascript:window.location.reload(true);" type="button" class="btn mr-1 mb-1 btn-secondary" style="float: right;">Yeniden Kontrol Et</button>
                        </div>
                    </div>
                </div>
            </div>
